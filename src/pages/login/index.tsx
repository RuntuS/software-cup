...
import { StyleImageBox, StyleLoginBody } from './style'
...
export const Login: React.FC<Props> = (props) => {
    ...
    return (
        <>
            <StyleImageBox style={{height: window.innerHeight}}>
                <img src="https://oss-album.oss-cn-beijing.aliyuncs.com/userImg/beijing.jpg"  alt='背景图片' />
            </StyleImageBox>
